...
})({"gAP6u":[function(require,module,exports) {
"use strict";
...
"use scrict";
const PAINT = new (0, _paint.Paint)(); // new Paint
const infoTarget = document.querySelector(".info"); // info trigger
const infoBar = document.querySelector(".info__bar"); // info banner
/* ===== Update canvas size ===== */ window.addEventListener("resize", function() {
    PAINT.update();
});
/* ===== Interface ===== */ infoTarget.addEventListener("mouseover", ()=>classToggle(infoBar, "_isActive"));
infoTarget.addEventListener("mouseout", ()=>classToggle(infoBar, "_isActive"));
/* ===== Class toggle ===== */ function classToggle(el, cls) {
    el.classList.contains(cls) ? el.classList.remove(cls) : el.classList.add(cls);
}

},{"./paint":"9puAF"}],"9puAF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/* ===== Paint ===== */ parcelHelpers.export(exports, "Paint", ()=>Paint);
...
},{}]},["gAP6u","5AKj5"], "5AKj5", "parcelRequirec03a")
